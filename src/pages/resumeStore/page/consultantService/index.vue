          ...
          >
            ...
            <el-table-column fixed="right" label="操作" width="100">
              ...
              <template slot-scope="scope">
                <!-- 如果不是系统自动，则显示操作列表 -->
                <div v-if="scope.row.interview!==null">
                  <div v-if="!scope.row.interview.isAutomatic && (scope.row.interview.status === 51 || scope.row.interview.status === 59)">
                    <p
...
export default class invitPro extends Vue {
  ...
  getData (page) {
    ...
    consultantServiceList(obj).then(res => {
  ...
  checkNote () {
    ...
    if (this.RusultForm.type === 1) {
      // console.log("扣点");
      servicePay(this.RusultForm.recommendId, {
