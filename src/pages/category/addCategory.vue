  ...
  <div class="set-recruiter-wrapper">
    <el-form ref="form" :model="ruleForm" :rules="formRules" label-width="140px">
      ...
      <el-form-item label="品类名称">
        <el-input v-model="ruleForm.name" :disabled="ruleForm.radio === '1' ? true : false " placeholder="请输入品类名称" style="width: 400px;"></el-input>
      </el-form-item>
      <el-form-item label="二级类别" v-if="$route.query.level === '1' && !$route.query.isedit">
        <div class="selectitem" @click="selectPosition($event, 2)">
      ...
      <el-form-item label="三级类别" v-if="$route.query.level === '2' && !$route.query.isedit">
      <div class="selectitem" @click="selectPosition($event, 3)">
